...
export const ProjectForm = () => {
    ...
    // fetch show from local storage
    const showLocal = localStorage.getItem('showLocal')
                ...
                {showLocal === "true" ?
                    ...
                    <div className="flex flex-row justify-around mt-12 text-center">
                        <div
                            ...
                            onClick={() => {
                                setShow(!show)
                                localStorage.setItem('showLocal', JSON.stringify(true))
                            }}>
                            <div>
                                Load More
                ...
                {showLocal === "true" ?
                    <div className="flex flex-row justify-around mt-12 text-center">
                        <div
                            ...
                            onClick={() => {
                                setShow(!show)
                                localStorage.setItem('showLocal', JSON.stringify(false))
                            }}>
                            <div>
                                Hide
